...
int main(void){
    ...
    long long int *cups1 { new long long int[n / 2] {}}, *cups2 {new long long int[n/2 + n % 2] {}}, *sums1 {new long long int[(long long int)pow(2, n/2)] {}}, *sums2 { new long long int[(long long int)pow(2, n/2 + n%2)] {}};
    ...
    if (abs(sum - min_diff * 2) == test4_ans) cout << "Test is passed\n";
